                ...
                <div className="row justify-content-center">             
                    ...
                    <div className="col-7 col-sm-5">
                        ...
                        <address>
                            ...
                            HONG KONG<br />
                            <i className="fa fa-phone fa-sm"></i>: +852 1234 5678<br />
                            <i className="fa fa-fax fa-sm"></i>: +852 8765 4321<br />
                            <i className="fa fa-envelope fa-sm"></i>: <a href="mailto:confusion@food.net">
                    ...
                    <div className="col-12 col-sm-4 align-self-center">
                        <div className="text-center">
                            ...
                            <a className="btn btn-social-icon btn-primary m-1" href="mailto:"><i className="fa fa-envelope-o"></i></a>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">             
